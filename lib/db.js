...
// Use globalThis to ensure single DB connection across all route handler bundles
if (!globalThis.__jenkinsDb) {
  ...
  globalThis.__jenkinsDb = db;
}

module.exports = globalThis.__jenkinsDb;
